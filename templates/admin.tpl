...
<head>
  ...
  <link href="<{$xoImgUrl}>admin/css/sb-admin-2.min.css" rel="stylesheet">
...
<body id="page-top">
  ...
  <script src="<{$xoImgUrl}>admin/vendor/jquery-easing/jquery.easing.min.js"></script>

  <!-- Custom scripts for all pages-->
  <script src="<{$xoImgUrl}>admin/js/sb-admin-2.min.js"></script>

  <!-- Page level plugins -->
  <script src="<{$xoImgUrl}>admin/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="<{$xoImgUrl}>admin/js/demo/chart-area-demo.js"></script>
  <script src="<{$xoImgUrl}>admin/js/demo/chart-pie-demo.js"></script>
