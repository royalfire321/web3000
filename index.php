...
switch ($op){
  ...
  case "reg1" :
     $msg = reg1();
    redirect_header("index.php", '訂位完成', 3000);
    exit;  
...
function reg1(){
  ...
  $sql="INSERT INTO `orders` (`name`, `date`, `email`, `time`, `phone`, `people`, `message`)
  VALUES ('{$_POST['name']}', '{$_POST['date']}', '{$_POST['email']}', '{$_POST['time']}', '{$_POST['phone']}', '{$_POST['people']}', '{$_POST['message']}');";
